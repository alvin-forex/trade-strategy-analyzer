...
try:
    from db_manager import load_scores
    HAS_DB = True
except ImportError:
    HAS_DB = False
...
EA_MAP = {
    'DW': ['10437','106','11984','13790','16538','17547','20846','21698','22200','22278','25830','31593','32541','32719','34259','36338','36397','36511','19625','35434','35436'],
...
def main():
    ...
    if HAS_DB:
        try:
            all_results = load_scores(version='v4')
    ...
    if not all_results:
        ...
        if not Path(pkl_path).exists():
            print("❌ Run dde_v4_scorer.py first to generate data")
            sys.exit(1)
